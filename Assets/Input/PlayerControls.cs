...
public class @PlayerControls : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""GroundMovement"",
            ""id"": ""1931bfda-673e-4397-b839-12add1e11812"",
            ""actions"": [
                {
                    ""name"": ""HorizontalMovement"",
                    ""type"": ""PassThrough"",
                    ""id"": ""21a54e1e-7b8b-4332-b61a-8fa12d990adc"",
                ...
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""884294a3-db86-4b18-b612-dd0a8525ef12"",
                ...
                },
                {
                    ""name"": ""MouseX"",
                    ""type"": ""PassThrough"",
                    ""id"": ""34fa8dc6-af8a-49af-9edb-e15db4a87f53"",
                ...
                },
                {
                    ""name"": ""MouseY"",
                    ""type"": ""PassThrough"",
                    ""id"": ""579340da-9637-4f66-9524-e22627a2208b"",
                    ""expectedControlType"": ""Axis"",
                    ""processors"": """",
                    ""interactions"": """"
                },
            ...
            ""bindings"": [
                {
                    ""name"": ""WASD"",
                    ""id"": ""e4788fb7-2e60-40d6-a6fd-04d9270b70de"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""71e770d0-de52-4193-8263-1d87431b3725"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""6ba687e0-b208-404e-a692-20fe40e21a19"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""09de2ff0-e75e-488e-8102-f3bb943009a5"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""ac5711ea-e5c9-4bf0-9f2a-34efdef35c1c"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""43635603-7ac2-462d-bfa4-597f60528d25"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""2125b41a-c210-4f50-a731-1d35263530c4"",
                    ""path"": ""<Mouse>/delta/x"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""23c0b835-3d86-46cd-94e1-1ccdf6bef002"",
                    ""path"": ""<Mouse>/delta/y"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
